...
public class GridlLines extends Component{
    ...
    public void update(float dt) {
        ...
        int numVerticalLines = (int) (projectionSize.x * camera.getZoom()/ Settings.GRID_WIDTH) + 2; // 1280 / 32 = 40
        int numHorizontalLines = (int) (projectionSize.y * camera.getZoom()/ Settings.GRID_HEIGHT) + 2; // 672 / 32 = 21
...
//        int numVerticalLines = (int) (projectionSize.x * camera.getZoom()/ Settings.GRID_WIDTH) + 2; // Add buffer
//        int numHorizontalLines = (int) (projectionSize.y * camera.getZoom()/ Settings.GRID_HEIGHT) + 2; // Add buffer
//
