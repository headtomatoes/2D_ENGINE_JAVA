...
import AnhNe.physics2d.primitives.*;
import AnhNe.Renderer.Lines2D;
import util.JMath;
...
public class IntersectionDetector2D {
    ...
    // ========================================================
    public static boolean pointOnLine(Vector2f point, Lines2D line) {
    ...
    // ========================================================
    public static boolean lineAndCircle(Lines2D line, Circle circle) {
    ...
    public static boolean lineAndAABB(Lines2D line, AABB box) {
    ...
    public static boolean lineAndBox2D(Lines2D line, Box2D box) {
        ...
        Lines2D localLine = new Lines2D(localStart, localEnd);
    ...
    // =============================================================================
    public static boolean circleAndLine(Circle circle, Lines2D line) {
